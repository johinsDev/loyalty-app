...
const sourceToken =
  process.env.BETTER_STACK_SOURCE_TOKEN_WEB ?? process.env.BETTER_STACK_SOURCE_TOKEN;
const host =
  process.env.BETTER_STACK_INGESTING_HOST_WEB ?? process.env.BETTER_STACK_INGESTING_HOST;

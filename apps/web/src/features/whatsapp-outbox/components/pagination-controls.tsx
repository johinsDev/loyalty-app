...
/**
 * URL-state pagination with the shadcn `Pagination` primitives.
 * Always rendered (even when there's a single page) so the table
 * footer height stays stable.
 */
...
/**
 * Returns the pages to render in the control, inserting `null` where
 * an ellipsis goes. Keeps first + last + a window around the current
 * page within `maxVisible` items.
 */

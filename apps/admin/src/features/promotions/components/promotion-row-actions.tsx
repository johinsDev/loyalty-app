...
export function PromotionRowActions({ promo }: { promo: PromoActionsRow }) {
  ...
  const canArchive = promo.status === "published";
  const canDelete = promo.status === "draft" || promo.uses === 0;
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-44">
          <DropdownMenuItem
            onClick={() => router.push({ pathname: "/promotions/[id]", params: { id: promo.id } })}
          >

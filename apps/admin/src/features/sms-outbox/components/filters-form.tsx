...
/**
 * URL-driven filter controls. Same shape as the WhatsApp outbox
 * filter form; reads its strings from a separate `SmsOutbox` i18n
 * namespace so the two surfaces can diverge later without touching
 * each other.
 */
export function FiltersForm() {
  const t = useTranslations("SmsOutbox");
